...
const App = () => {
  ...
  const [navigationData, setNavigationData] = useState({
    'items':[
      {'pathDesktop':clockPathDesktop, 'pathMobile':clockPathMobile, 'value':'8-9 октября • 19:00'},
      {'pathDesktop':locationPathDesktop, 'pathMobile':locationPathMobile, 'value':'Киностудия Лендок', 'link':locationLink}
    ]
  })
